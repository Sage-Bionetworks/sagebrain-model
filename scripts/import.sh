...
biolink_LOWER=(Gene Pathway Disease Drug ClinicalTrial MaterialSample participates_in treats)
biolink_ROOTS=(Entity participates_in treats)
biolink_TITLE="Biolink Model -- SageBrain import module"
biolink_DESCRIPTION="MIREOT extract of the Biolink Model terms SageBrain reuses (gene, pathway, disease, drug, clinical trial, material sample, participates in, treats) and their ancestors. Generated by scripts/import.sh from Biolink v${biolink_VERSION}; do not edit by hand."
