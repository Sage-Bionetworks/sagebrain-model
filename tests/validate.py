...
Six checks:
  ...
  7. (opt-in, set WITH_GOVERNANCE=1) ontology/governance/ -- the pipeline
...
def main():
    ...
    # 7. (opt-in) the governance pipeline-provenance layer
    if WITH_GOVERNANCE:
        ...
        print("[7] governance layer (WITH_GOVERNANCE=1):")
        ...
        print("[7] governance layer: skipped (set WITH_GOVERNANCE=1 to check)")
