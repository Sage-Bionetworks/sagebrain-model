...
Pathway edge, and each pathway's Pathway -> DiseaseStage edge below). A third
v0.4 addition, `sagebrain:de_associated_with_disease` (Pathway -> DiseaseLabel,
...
(DE-derived vs. not), not just two names for one fact. The model is a work in
